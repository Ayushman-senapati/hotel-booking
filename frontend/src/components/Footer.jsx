        ...
        <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 bg-[#F6F9FC]'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    <img src={assets.logo} className='invert mb-2 opacity-80' />
                    <p className='text-sm'>
                ...
                <div>
                    <p className='text-lg text-gray-800 font-pf '>COMPANY</p>
                ...
                <div>
                    <p className='text-lg text-gray-800 font-pf '>SUPPORT</p>
                    <ul className='mt-3 flex flex-col gap-2 text-sm'>
                ...
                <div className='max-w-80'>
                    <p className='text-lg text-gray-800 font-pf '>STAY UPDATED</p>
