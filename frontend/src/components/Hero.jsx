...
const Hero = () => {
  return (
    ...
    bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-center bg-cover h-screen '>
      <p>The Ultimate Hotel Experience</p>
      <h1 className='font-pf text-2xl md:text-5xl md:text-[56px] md:leading-[56px]
      font-bold md:font-extrabold max-w-xl mt-4'>Discover Your Perfect Destination</h1>
        <p className='max-w-130 mt-2 text-sm md:text-base'
        >Unparalled luxury and comfort await at the world's most exclusive hotels and
