...
const Testimonials = () => {
  return (
    <div className=' flex flex-col items-center px-6 bg-slate-50 pt-10 pb-30'>
        <Title title='What Our Guests Say' subtitle='Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat error tempora numquam debitis quod. Dolores, dolor pariatur. 
 Delectus, perspiciatis omnis.' />
